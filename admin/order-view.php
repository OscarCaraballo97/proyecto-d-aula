                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <td class="text-center">
                                ...
                                <?php 
                                    if(is_file("./imagenes/comprobantes/".$order['Adjunto'])){
                                      echo '<a href="./imagenes/comprobantes/'.$order['Adjunto'].'" target="_blank" class="btn btn-raised btn-xs btn-info btn-block">Comprobante</a>';
                                    }
                                ?>
