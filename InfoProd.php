    ...
    <section id="infoproduct">
        <div class="container">
            <div class="row">
                ...
                <?php 
                    $CodigoProducto=consultas::clean_string($_GET['CodigoProd']);
                    $productoinfo=  ejecutar::consultar("SELECT producto.CodigoProd,producto.NombreProd,producto.CodigoCat,categoria.Nombre,producto.Precio,producto.Descuento,producto.Stock,producto.Imagen FROM categoria INNER JOIN producto ON producto.CodigoCat=categoria.CodigoCat  WHERE CodigoProd='".$CodigoProducto."'");
                    while($fila=mysqli_fetch_array($productoinfo, MYSQLI_ASSOC)){
                        echo '
                            <div class="col-xs-12 col-sm-6">
                                ...
                                if($fila['Imagen']!="" && is_file("./imagenes/img-products/".$fila['Imagen'])){ 
                                    $imagenFile="./imagenes/img-products/".$fila['Imagen']; 
                                }else{ 
